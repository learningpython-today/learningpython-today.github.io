...
2. *Extract content from response object*, by accessing the .text attribute and calling ``json.loads`` if the string is in JSON format (formatted in such a way that it follows the JSON rules).
